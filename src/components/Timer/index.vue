<template>
  <div class="clock1">
    ...
    <span class="first-hand"></span>
    <span class="third-hand"></span>
...
<style scoped>
  ...
  #start:checked ~ .first-hand {
    animation-play-state: running;
  }

  #stop:checked ~ .first-hand {
    animation-play-state: paused;
  }

  #reset:checked ~ .first-hand {
    animation: none;
  }

  #start:checked ~ .third-hand {
    animation-play-state: running;
  }

  #stop:checked ~ .third-hand {
    animation-play-state: paused;
  }

  #reset:checked ~ .third-hand {
    animation: none;
  }
